...
* the files for taking the diceroller function and making into a package (which includes the description, licence, etc.)
...
* creating an R package (in this case, a dice roller for Dungeons and Dragons that does attack rolls)
